			...
			success:function(data){
				...
				for(var i=0;i<data.results.length;i++){
					...
					tr.append(td4);
						...
						var td2=$("<td>"+data.results[i].userName+"</td>");
						var td3=$("<td>"+data.results[i].creattime+"</td>");
						var td4=$("<td><a disabled='true' class='a-disable'  href=' javascript:void(0);  target='_self' onClick='' data-id='"
								+data.results[i].id+"' class='down btn btn-default btn-xs'>修改</a><a href='javascript:void(0);' onClick='restartThisUser(this)' data-id='"
								+data.results[i].id+"' class='down btn btn-default btn-xs'>重启</a>"
								+"<a class='a-disable' href='javascript:void(0);' onClick='' data-id='"
								+data.results[i].id+"' class='down btn btn-default btn-xs del'> 删除</a><a class='a-disable' href='javascript:void(0);' onClick='' data-id='"
								+data.results[i].id+"' class='down btn btn-default btn-xs'>重置</a></td>");
						$("#userTable tbody").append(tr);
						tr.append(td1);
						tr.append(td2);
