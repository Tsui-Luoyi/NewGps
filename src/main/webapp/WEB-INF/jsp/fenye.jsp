...
<body>
	...
	<script src="${pageContext.request.contextPath}/web/js/jquery.dataTables.js"></script>
	<script src="${pageContext.request.contextPath}/web/js/dataTables.bootstrap.js"></script>
	<script src="${pageContext.request.contextPath}/web/js/datatable.select.js"></script>
	<script>
		$(function(){
			ajaxPaging();
			//查询时
		...
		function ajaxPaging(){
			$.ajax({
			url:"${pageContext.request.contextPath}/logintest/list",
			type:"post",
			dataType:"json",
			...
			success:function(data){
				...
				for(var i=0;i<data.results.length;i++){
					...
					var td6=$("<td><a href='javascript:void(0);' onClick='stopThisCustomer(this)' data-id='"
							+data.results[i].id+"' class='down btn btn-default btn-xs'>停用</a>"
							+"<a href='javascript:void(0);' onClick='deleteThisCustomer(this)' data-id='"
