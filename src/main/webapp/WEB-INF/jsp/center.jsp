...
<link rel="shortcut icon" href="/NewRmgps/web/imgs/5.ico" type="image/x-icon" />
...
<link rel="stylesheet" href="/NewRmgps/web/css/index.css">
...
<body>
		...
		<div class="navbar navbar-default bg-blue navPos" role="navigation">
			...
			<div class="collapse navbar-collapse pull-right" id="navMenu">
				<ul class="nav nav-pills">
					<li class="active"><a href="/NewRmgps/User/toManagerCenter;" target="mainIframe">管理中心</a></li>
					<li><a href="/NewRmgps/User/toPositionCenter;" target="mainIframe">位置监测</a></li>
					<li><a
	...
	<div class="outerIframeContainer">
		<iframe id="mainIframe" name="mainIframe" src="/NewRmgps/User/toManagerCenter" frameborder="0"
	...
	<script src="/NewRmgps/web/js/index.js"></script>
</body>
</html>