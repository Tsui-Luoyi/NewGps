...
.ztree li span.button.carSet_ico_open {
	background-image: url("/NewRmgps/web/images/carSet.png")
}
/* 车辆 */
...
.ztree li span.button.groupSet_ico_open {
	background-image: url("/NewRmgps/web/images/groupSet.png")
}
/* 分组 */
...
.ztree li span.button.cmdSet_ico_open {
	background-image: url("/NewRmgps/web/images/cmdSet.png")
}
/* 命令 */
...
.ztree li span.button.add_ico_docu {
	background-image: url("/NewRmgps/web/images/add.png")
}
/* 修改 */
.ztree li span.button.change_ico_docu {
	background-image: url("/NewRmgps/web/images/change.png")
}
/* 查询 */
.ztree li span.button.find_ico_docu {
	background-image: url("/NewRmgps/web/images/find.png")
}
/* 删除 */
.ztree li span.button.delete_ico_docu {
	background-image: url("/NewRmgps/web/images/delete.png")
}
/* 停用 */
.ztree li span.button.stop_ico_docu {
	background-image: url("/NewRmgps/web/images/stop.png")
}
/* 移动 */
.ztree li span.button.move_ico_docu {
	background-image: url("/NewRmgps/web/images/move.png")
}
/* 允许 */
.ztree li span.button.allow_ico_docu {
	background-image: url("/NewRmgps/web/images/allow.png")
}
/* 不允许 */
