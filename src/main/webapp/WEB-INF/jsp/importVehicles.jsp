...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form id="vehicleUpload" action="/NewRmgps/Vehicle/uploadExcelFile" method="post"  enctype="multipart/form-data">
			<!-- <input id="vehicle" type='file' name="vehicle" accept="application/vnd.ms-excel"/> -->
			<input id="vehicle" type='file' name="fileName" />
			<input id="exlSubmit" type="submit" value="上传">
			</form>
			...
			<div class="col-lg-push-3 col-md-push-3 col-sm-push-3 col-lg-9 col-md-9 col-sm-9 col-xs-12">
				...
				<ol id="noticeOl">
					...
					<li>导入的文件是EXCEL表格文件，后缀名为<strong>.xls</strong>，并且里面的数据要遵循一定的格式，否则导入失败；</li>
					<li>可按照提供的模板添加车辆信息，<a class="right" href="/excelFile/vehicle_20170919150139.xls">点击下载模板</a>；</li>
