...
<link rel="stylesheet" href="/NewRmgps/web/css/menagerCenter.css">
...
<body>
	<div class="container-fluit">
		<div class="row-fluit">
			...
			<div class="col-lg-10 col-md-9 col-sm-9 col-xs-12"
				...
				<div id="midToggleBar"></div>
				<iframe id="managerInnerIframe" name="managerInnerIframe" src="/NewRmgps/User/tomanager" frameborder="0"
	...
	<script src="/NewRmgps/web/js/menagerCenter.js"></script>
</body>
</html>