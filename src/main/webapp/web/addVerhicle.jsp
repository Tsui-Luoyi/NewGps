		...
		<div class="row-fluid">
			...
			<div class="row" id="tabWrap">
				<div id="verhicleInfo">
					...
					<form id="addVerhicleForm" action="http://127.0.0.1/ceshi.php"
						class="form-horizontal" role="form" method="post">
						<!-- 车牌号 -->
						<div class="form-group">
							...
							<div class="col-lg-7 col-md-7 col-sm-7 col-xs-8 text-left">
								<input type="text" class="form-control" name="verhicleNum"
				...
				<div id="verhicleDetail">
					<form id="addVerhicleDetailForm"
						action="http://127.0.0.1/ceshi.php" class="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleNum2"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleName"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleBrand"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleProducter"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<div id="verhicleColorContainer">
									<select name="verhicleColor" id="verhicleColor">
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control"
									name="verhicleEngineCode" id="verhicleEngineCode"
									placeholder="请输入发动机号" />
							</div>
						</div>
						<!-- 车辆详细信息提交 -->
				...
				<div id="verhicleOwener">
					<form id="addVerhicleUserForm" action="http://127.0.0.1/ceshi.php"
						class="form-horizontal" role="form" method="post">
						<!-- 车主姓名 -->
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleUserName"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleUserPhone"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleUserTel"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="verhicleUserID"
						...
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="driveLicenseDate"
									id="driveLicenseDate" />
							</div>
						</div>
						<!-- 驾驶证号 -->
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
								<input type="text" class="form-control" name="driveLicenseNum"
									id="driveLicenseNum" />
							</div>
						</div>
	...
	<script>
		$(function(){
			...
			function verhicleDetail(){
				...
				/*  提交*/
				$("#addVerhicleDetailForm input:button").click(function(){
					...
					data:$("#addVerhicleDetailForm").serialize(),
					success:function(){
						alert("添加车辆信息成功！");
						$("#verhicleDetail").hide();
						$("#verhicleOwener").show();
			...
			function verhicleOwener(){
				...
				/* 车主信息提交 */
				$("#addVerhicleUserForm input:button").click(function(){
					...
					data:$("#addVerhicleUserForm").serialize(),
					success:function(){
						alert("添加车主信息成功！")
					},
					error:function(e){
