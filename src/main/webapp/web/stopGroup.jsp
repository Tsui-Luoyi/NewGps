...
<h4>重新启用已停用分组:</h4>
	<table class="sea" cellspacing="0" width="100%">
		<tr>
			<td width="15%"></td>
			<td width="70%">搜索分组：<input type="text" id="searchGroup" /><button id="findBtn">查询</button></td>
			<!-- <td width="35%">搜索电话：<input type="number" id="searchTel" /><button id="findBtn">查询</button></td> -->
			<td width="15%"><button>导出EXCEL</button></td>
		</tr>
	</table>
	<div id="pageSetting">
		<div id="pageSizeDiv">
	...
	<table id="groupTable" border="1px" class="hover" cellspacing="0"
		...
		<tfoot>
			<tr>
				<th width='10%' class="checkAll"><button id="restartSelected">启用选中</button></th>
				<th width='30%'>分组名字</th>
				<th width='25%' class="">添加时间</th>
				<th width='35%'>操作</th>
			</tr>
		...
		function ajaxPaging(){
			...
			success:function(data){
				...
				for(var i=0;i<data.results.length;i++){
					...
					var td4=$("<td><a href='javascript:void(0);' onClick='restartThisGroup(this)' data-id='"
