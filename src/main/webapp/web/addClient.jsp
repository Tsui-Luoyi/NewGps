	...
	<div class="container-fluid">
		...
		<h4>添加客户:</h4>	
			<form id="addClientForm" action="#" class="form-horizontal"
					role="form" method="post" onsubmit="return postData()">
				<div class="form-group">
					...
					<div class="form-group">
						<label for="clientAddr"
							class="col-lg-3 col-md-3 col-sm-3 col-xs-4 control-label text-right">客户地址：</label>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 text-left">
							<input type="text" class="form-control" id="clientName"
								placeholder="请输入客户地址">
						</div>
					...
					<div class="form-group">
						<div class="col-lg-7 col-md-7 col-sm-7 col-xs-10 text-center">
							...
							<input type="reset" class="btn btn-danger reset"/>
						</div>
					</div>
			</form>
			</div>
	...
	<script>
		function postData(){
			$.ajax({
				  type: 'POST',
				  url: url,
				  data: $("#addClientForm").serializeArray(),
				  dataType: json,
